...
const DisplayAllProducts: React.FC = () => {
  ...
  return (
    <div className="w-full h-full px-4 py-3">
      <div className="text-2xl text-center  font-semibold font-mono">
        Website For You!
      </div>

      <div className="grid mt-4 pb-7 lg:grid-cols-3 md:grid-cols-2 grid-cols-1  xl:grid-cols-4 2xl:grid-cols-5 gap-4">
        {products.map((product, index) => (
          <div
            key={index}
            className="max-w-[300px] h-full mx-auto w-full md:mx-auto"
